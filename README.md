...
- API service to publish messages into NATS JetStream
- NATS JetStream backend for message streaming
- Worker pool that consumes messages and produces AI-enriched responses
...
- `langgraph`: placeholder for LangGraph integration
